...
import com.infy.eon.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.infy.eon.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "*", allowedHeaders = "*") public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "demoCustomer";
